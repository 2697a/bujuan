                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text("${profile.profile.nickname}",
                                style: TextStyle(
                                    fontSize: 22.0,
                      ...
                      Container(
                        child: Text("${profile.profile.signature}",style: TextStyle(color: Colors.grey[500],fontSize: 12.0),),
                      ),
                      Padding(padding: EdgeInsets.symmetric(vertical: 1.5)),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Container(
                            padding: EdgeInsets.symmetric(horizontal: 15.0),
                            child: Text("关注：${profile.profile.follows}",
                                style: TextStyle(
                                    fontSize: 14.0,
                                    fontWeight: FontWeight.bold)),
                          ),
                          Container(
                            padding: EdgeInsets.symmetric(horizontal: 8.0,vertical: 2.0),
                            child: Text("粉丝：${profile.profile.followeds}",
                                style: TextStyle(
                                    fontSize: 14.0,
                                    fontWeight: FontWeight.bold)),
                          ),
                          Container(
                            ...
                            child: Text("听歌量：${profile.listenSongs}",
                                style: TextStyle(
                                    fontSize: 14.0,
                                    fontWeight: FontWeight.bold)),
                          )
