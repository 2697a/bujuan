...
class LyricView extends GetView<HomeController> {
  ...
  Widget _buildLyric(BuildContext context) {
    return ClassStatelessWidget(child: Obx(() {
      return Padding(
        ...
        child: Visibility(
          ...
          child: Listener(
            ...
            child: ClassStatelessWidget(child: ClickableListWheelScrollView(
              ...
              child: ListWheelScrollView.useDelegate(
                itemExtent: controller.hasTran.value ? 162.w : 90.w,
                ...
                childDelegate: ListWheelChildBuilderDelegate(
                  builder: (context, index) =>ClassStatelessWidget(child:  Container(
                    width: Get.width,
                    height: controller.hasTran.value ? 162.w : 90.w,
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(fontSize: controller.hasTran.value ? 30.sp : 32.sp, color: controller.bodyColor.value),
                        ...
                        Visibility(
                            visible: controller.hasTran.value,
                            child: Text(controller.lyricsLineModels[index].extText ?? '',
                                style: TextStyle(
