        ...
        children: [
          Expanded(
            ...
            panel: Obx(() => Container(
                  ...
                  decoration:
                      BoxDecoration(color: controller.rx.value.dark?.color, borderRadius: BorderRadius.only(topLeft: Radius.circular(35.w), topRight: Radius.circular(35.w))),
                  child: Column(
                    children: [
                ...
                Obx(() => Container(
                      decoration: BoxDecoration(
                          gradient: LinearGradient(colors: [
                            Theme.of(context).bottomAppBarColor.withOpacity(controller.second.value ? (1 - controller.slidePosition.value) : controller.slidePosition.value*.98),
                        controller.rx.value.light?.color.withOpacity(controller.second.value ? (1 - controller.slidePosition.value) : controller.slidePosition.value) ??
                            Colors.transparent,
                        ...
                        labels: controller.mEffects
                            .map((e) => FlutterSliderHatchMarkLabel(
                                ...
                                label: Container(
                                  height: e['size'],
                                  width: 1,
                                  color: controller.rx.value.dark?.bodyTextColor.withOpacity(.4) ?? Colors.white.withOpacity(.3),
                                )))
                            .toList(),
                  ...
                  child: InkWell(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(color: controller.rx.value.dark?.color.withOpacity(.3) ?? Colors.transparent, width: 6.w)),
                      child: Icon(
                        controller.playing.value ? TablerIcons.player_pause : TablerIcons.player_play,
                        size: 52.w,
                        color: controller.rx.value.dark?.bodyTextColor.withOpacity(.8),
                      ),
                    ),
        ...
        child: Row(
          ...
          children: [
            ...
            IconButton(
                ...
                icon: Icon(
                  TablerIcons.trash_x,
                  color: controller.rx.value.dark?.bodyTextColor.withOpacity(.4),
                  size: 42.w,
                ))
          ],
        ),
