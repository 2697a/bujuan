        ...
        child: Column(
          ...
          children: [
            Visibility(
              child: Padding(
                padding: EdgeInsets.only(
                    top: MediaQuery.of(Get.context).padding.top.h),
              ),
            ...
            Expanded(
              ...
              children: [
                playView(HomeController.to),
                lyricView(HomeController.to)
              ],
            )),
            Container(
              height: 60.h,
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                      icon:
                          Icon(const IconData(0xe8ae, fontFamily: 'iconfont')),
                      onPressed: () =>
        ...
        children: [
          Center(
            child: _buildMusicCover(
                HomeController.to.miniPlayView ? 300.h : 300.h),
          ),
          Container(
                  ...
                  () => InkWell(
                    child: Container(
                      ...
                      child: Icon(
                        Icons.favorite,
                        size: 26.sp,
                        color: homeController.likeSongs
              ...
              child: SliderTheme(
                  data: SliderThemeData(
                      ...
                      thumbShape: RoundSliderThumbShape(
                          enabledThumbRadius: 6.0, pressedElevation: 8.0)),
                  child: Slider(
                    activeColor: Theme.of(Get.context).accentColor,
                    inactiveColor:
                        Theme.of(Get.context).accentColor.withOpacity(.3),
        ...
        SleekCircularSlider(
          appearance: CircularSliderAppearance(
              ...
              customWidths: CustomSliderWidths(
                  trackWidth: 1, progressBarWidth: 4.5, handlerSize: 1.5)),
          min: 0,
          max: 1,
          innerWidget: (v) => Text(''),
          initialValue: controller.playPos.value /
              (controller.song.value.duration ~/ 1000),
          onChange: (value) {
