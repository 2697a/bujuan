  ...
  Widget _buildPortrait() {
    return Column(
      children: [
        ...
        Obx(()=>GetUtils.isNullOrBlank(controller.lyric.value) ||
            GetUtils.isNullOrBlank(controller.lyric.value.lrc) ||
            GetUtils.isNullOrBlank(controller.lyric.value.lrc.lyric)
            ? Expanded(
            child: Center(
              child: Text('暂无歌词'),
            ))
